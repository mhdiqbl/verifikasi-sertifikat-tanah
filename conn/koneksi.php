...
$conn	= mysqli_connect('localhost', 'root','', 'bpnacut');
...
function showtables(){
	global $conn;
	$table = mysqli_query($conn,"SELECT * FROM sertifikat INNER JOIN desa ON sertifikat.id_desa = desa.id_desa INNER JOIN kecamatan ON desa.id_kecamatan = kecamatan.id_kecamatan");
	return $table;
}
...
function registrasi($data){
	...
	// tambahkan userbaru ke database
	mysqli_query($conn, "INSERT INTO tb_admin VALUES('$username','$nama','$jk','$email','$no_tlp','$alamat','$tp_lahir','$tgl_lahir','$gambar','$password')");
...
function tambah_pegawai($data){
	...
	$password = password_hash($password, PASSWORD_DEFAULT);
	// tambahkan userbaru ke database
	mysqli_query($conn, "INSERT INTO pegawai VALUES('$id_pegawai','$nm_pegawai','$jk','$email','$no_tlp','$alamat','$tp_lahir','$tgl_lahir','$gambar','$password','$id_hak_akses')");
