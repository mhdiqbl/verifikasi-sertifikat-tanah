...
if (!isset($_SESSION['login']) && $role == '01') {
          ...
          <div class="clearfix"></div>
                  ...
                  <div class="x_content">
                    ...
                    $no = 1; ?>
                      ...
                      <tr>
                      <!-- <td><input type="checkbox" id="check-all" name="id_bukutanah" value="<?php echo $d['no_sertifikat']?>" ></td> -->
                      <td><?php echo $no++?></td>
                      ...
                      <td class="text-center">
                        <div class="btn-group">
                            <a href="pengambilan.php?no_sertifikat=<?php echo $d['no_sertifikat'];?>" data-toggle="tooltip" data-placement="top" name="ambil" title="Ambil" class="btn btn-warning"><i class="fa fa-send"></i></a>
                            <a href="update.php?no_sertifikat=<?php echo $d['no_sertifikat'];?>" data-toggle="tooltip" data-placement="top" name="edit" title="Edit" class="btn btn-info"><i class="fa fa-edit"></i></a>
                            <a href="hapus.php?no_sertifikat=<?php echo $d['no_sertifikat'];?>" onclick="return confirm('YAKIN INGIN MENGHAPUS DATA?');" name="hapus" data-toggle="tooltip" data-placement="top" title="Delete" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                        </div>
                    </td>
                    </tr>
                    <?php endforeach; ?>
