...
//ambil data dari URL
$bt = $_GET["no_sertifikat"];

$bkt = query("SELECT * FROM sertifikat WHERE no_sertifikat = '$bt'")[0];
          ...
          <div class="clearfix"></div>
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								<div class="x_title">
									<h2>Edit Entri Sertifikat Tanah <small></small></h2>
									<div class="clearfix"></div>
								</div>
								<div class="x_content">
									<br>
                      ...
                      <input type="hidden" name="kd" value="<?= $bkt["no_sertifikat"] ?>">
											<div class="col-md-6 col-sm-6 ">
												<input type="text" class="form-control col-5" name="no_sertifikat" value="<?= $bkt["no_sertifikat"] ?>">
											</div>
										</div>
										<div class="item form-group">
                          ...
                          ?>
                            ...
                            <option value="<?= $d['id_hak'] ?>" <?php if($bkt["id_hak"] == $d["id_hak"]){ echo 'selected'; } ?> ><?= $d['nm_hak']?></option>
                            <?php endforeach; ?>
                        </select>
											</div>
										</div>                  
                        ...
                        <!-- <input class="form-control col-5" name="id_desa" list="desa" value="<?= $bkt["id_desa"] ?>""> -->
                          ...
                          ?>
                            ...
                            <option value="<?= $ds['id_desa']?>" <?php if($bkt["id_desa"] == $ds["id_desa"]){ echo 'selected'; } ?>><?= $ds['nm_desa']?></option>
                            <?php endforeach; ?>
                        </select>
											</div>
										</div>
